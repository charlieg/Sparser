...
;; ditto 5/17/98. Ditton 2/17/05. Added BBN 3/9/07, refined 7/5. 4/24 extended
;; copyright info to 2008. 7/22/09 extended it again
...
(defparameter *salutation-string*
  ...
  (format nil "~&~%Welcome to the Sparser natural language analysis system~
               ~%  copyright (c) David D. McDonald 1991-2005~
               ~%  extensions copyright (c) BBN Solutions LLC. 2006-2009 All Rights Reserved
               ~%~
