...
;;;
;;;      File:  "academic grammar"
;;;    Module:  "init;versions:v2.7:config:grammars:"
;;;   version:  v2.7 October 1997

;; cloned from [full grammar] 5/31/96.  7/21 added *nih*.  9/22 took it out
;; since it's likely to regularly load with glitches, and the errors/breaks
;; will trash the procedure for creating a grammar image.
