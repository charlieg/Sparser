...
;;------------ Specialize this one ------------
(defparameter *target-root-for-copy* '("Moby" "Sparser archive"
                                       "JDP" 
                                       "code" "s" ))
...
(copy-source-to-new-root "init;scripts:compile academic")
(copy-source-to-new-root "init;scripts:copy academic")
