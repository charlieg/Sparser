...
(defun ref/function (rule-field)
  (let ((n-ary-rule
   ...
   #|--- Commenting out the annotation. The direction is bad/presumptious
      anyway. Consider the rule for company + comma-inc-term.  Need a
      set of schemas based on names.
